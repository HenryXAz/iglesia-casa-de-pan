<div class="w-full text-gray-700 bg-light-color-2 dark-mode:text-gray-200 dark:bg-dark-color-1 p-2">
    <div x-data="{ open: false }"
        ...
        <div class="p-4 flex flex-row items-center justify-between">
            <a href="{{route('home')}}"
               class="text-sm lg:text-lg font-semibold tracking-widest text-light-text uppercase rounded-lg dark:text-dark-text focus:outline-none focus:shadow-outline">
        ...
        <nav :class="{'flex': open, 'hidden': !open}"
            ...
            @if (Auth::user())
                ...
                <a class="{{"px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark:hover:bg-dark-color-2 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark:hover:text-dark-text dark:text-dark-text md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline " . (request()->routeIs('blog') ? ' bg-main-primary text-dark-text' : '')  }}"
